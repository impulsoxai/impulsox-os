...
**Aceite da ordem de leitura (anti-cold-start, padrão Brain do Matt/Focus Pilot):**
antes do primeiro slide/rascunho, citar em 1 linha interna 2 marcadores da voz que vão
entrar na peça + qual exemplo BOM foi lido. Pedido frio ("faz um carrossel") sem essa
leitura produz escrita genérica de IA em QUALQUER modelo — primeiro o cérebro, depois
a peça.
...
copy visível · a palavra "marketing" em peça pública · caixa-alta emocional ·
