...
fecho? Um pitch de 6 a 8 slides oscila 2 ou 3 vezes. O mapa do arco vem antes da copy.

> Exemplo na voz da ImpulsoX (oscilação): vale, "São 22h, o cliente manda mensagem e
> ninguém responde." pico, "Imagina esse mesmo cliente atendido na hora, sozinho." vale,
> "Hoje a maioria das empresas só usa o ChatGPT pra perguntar coisa solta." pico, "A virada
> é a IA virar funcionário do negócio." Cada par puxa o ouvinte pra frente.
...
1. **Abrir com a mudança grande e inegável.** Não o concorrente, não o produto: o **status
   ...
   Da ImpulsoX: a adoção de IA já virou, a maioria das PMEs já testou, mas quase ninguém usa
   de verdade. O número exato vem do banco de provas `mercado-ia-pme-brasil`, citando a
...
4. **O produto como o caminho.** Só agora entra o que você faz, apresentado como o MEIO de
   ...
   conteúdo e IA são como o ouvinte cruza do vale pro pico.
...
> ir pra terra prometida e prova.
...
```
        Resultado dos Sonhos  x  Probabilidade Percebida
Valor = ------------------------------------------------
              Tempo até o resultado  x  Esforço
```

- **Subir o resultado dos sonhos**: pinta o que o dono realmente quer (não "uma página", e
  sim "uma empresa que o cliente confia no primeiro segundo").
- **Subir a probabilidade percebida**: vem de **prova real ou garantia de processo**, nunca
  de afirmação. É aqui que o pitch fraco quebra: promete resultado sem prova. Garantia de
  entrega (SLA) e portfólio sobem essa alavanca honestamente.
- **Baixar o tempo**: o quão rápido o dono vê o primeiro ganho.
- **Baixar o esforço**: done-for-you mata o esforço. "Você aprova, a IA trabalha" é alavanca
  de esforço, dita de propósito.
...
de oferta mostra o conjunto (página, conteúdo e IA juntos), não três serviços soltos.
...
- **Abrir pelo "depois".** Antes de mostrar um clique, mostrar o resultado: "olha a página
  no ar" ou "olha o post saindo pronto". O ouvinte se vê no futuro antes de ver a mecânica.
...
1. **Só oferta ATIVA.** O pitch só vende o que existe à venda hoje. Roadmap, futura ou "em
   breve" fica fora. Vender o que não existe expõe o cliente quando ele cobra a entrega.
