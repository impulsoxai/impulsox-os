...
ativa em cor saiu direto do padrão de Chase/Matt/Yury (eles usam vermelho/branco). A lei
compartilhada de retenção (3s, muted-first, Quality-CTR) mora em `docs/craft-video.md`. Molde
