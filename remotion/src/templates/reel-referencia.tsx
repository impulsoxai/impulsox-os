...
// A skill /reel-marca COPIA este arquivo pra remotion/src/<slug>.tsx e adapta: cenas, copy
// (legendas), produto real (carrosséis/páginas), trilha. NÃO editar este molde — é a referência
// da fórmula 5-beats (hook → problema/money shot → variedade → diferencial → assinatura).
// Cores/fontes vêm de ../tema (marca do cliente). Reusa ../premium ../efeitos ../produto.
